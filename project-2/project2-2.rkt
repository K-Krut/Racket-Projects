...
(define wave-painter
  (segments->painter
   (list (make-segment (make-vect 0 0) (make-vect 0.33 0.33))
         (make-segment (make-vect 0.33 0.33) (make-vect 0.66 0))
         (make-segment (make-vect 0.66 0) (make-vect 1 0.33))
         (make-segment (make-vect 1 0.33) (make-vect 0.66 0.66))
         (make-segment (make-vect 0.66 0.66) (make-vect 0.33 0.33))
         (make-segment (make-vect 0.33 0.33) (make-vect 0 0.66)))))
